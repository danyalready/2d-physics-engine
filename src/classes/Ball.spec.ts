...
describe('Ball class:', () => {
    test('repositionate public method', () => {
        const ball = new Ball({ mass: 1, accelerationUnit: 1, coordinate: { x: 0, y: 0 }, radius: 2 });
    ...
    test('isCollision static method', () => {
        const ball1 = new Ball({ mass: 1, accelerationUnit: 0, coordinate: { x: 5, y: 5 }, radius: 15 });
        const ball2 = new Ball({ mass: 1, accelerationUnit: 0, coordinate: { x: 10, y: 5 }, radius: 10 });
    ...
    test('resolvePenetration static method', () => {
        const ball1 = new Ball({ mass: 1, accelerationUnit: 0, coordinate: { x: 5, y: 5 }, radius: 3 });
        const ball2 = new Ball({ mass: 1, accelerationUnit: 0, coordinate: { x: 10, y: 5 }, radius: 3 });
